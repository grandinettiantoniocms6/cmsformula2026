...
( function () {
        ...
        Riode.$body
            ...
            .on( 'click', '.tab .nav-link', function ( e ) {
                ...
                if ( !$this.hasClass( "active" ) ) {
                    ...
                    // owl-carousel init
                    Riode.slider( $panel.find( '.owl-carousel-shop' ) );
        ...
        Sidebar.prototype.toggle = function () {
            ...
            if ( window.innerWidth >= Riode.minDesktopWidth && self.$sidebar.hasClass( 'sidebar-fixed' ) ) {
                ...
                if ( window.innerWidth >= 1200 && Riode.$body.hasClass( 'with-flex-container' ) ) {
                    $( '.owl-carousel-shop' ).trigger( 'refresh.owl.carousel' );
                }
            }
        }
    ...
    Riode.initProductSingle = ( function () {
        ...
        ProductSingle.prototype.init = function ( $el ) {
            ...
            $slider.on( 'initialized.owl.carousel', function ( e ) {
                ...
                self.isQuickview || $slider.append( '<a href="#" class="product-image-full"><i class="d-icon-search"></i></a>' );
    ...
    Riode.Minipopup = ( function () {
        ...
        return {
            init: function () {
                ...
                Riode.byClass( 'page-content' )[ 0 ].appendChild( area );
    ...
    Riode.init = function () {
        ...
        Riode.slider( '.owl-carousel-shop' );                                        // Initialize slider
...
jQuery(document).ready(function(){
    jQuery('a[rel=popover]').popover({
        ...
        placement: 'top',
        content: function(){
            return '<img width="150" height="150" src="'+$(this).data('img') + '" /><div class="title">'+$(this).data('name') + '</div>';
        }
    });
});
