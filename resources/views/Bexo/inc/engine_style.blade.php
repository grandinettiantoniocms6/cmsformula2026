...
<style>
    :root {
        ...
        @if($website->menu_link_visited_color)
            --header-link-visited-color: {{ $website->menu_link_visited_color }};
        @else
            --header-link-visited-color: {{ $website->header_color_hover }};
        @endif
    ...
    #mobile-menu > ul > li.is-current-menu > a,
    #mobile-menu .sub-menu > li.is-current-menu > a,
    .mean-container .mean-nav ul li.is-current-menu > a {
        color: var(--header-link-visited-color) !important;
    }

    @if(!empty($website->menu_link_visited_color))
        #mobile-menu > ul > li > a.is-current-menu-link,
        #mobile-menu .sub-menu > li > a.is-current-menu-link,
        .header-area .mainmenu > ul > li > a.is-current-menu-link,
        .header-area .mainmenu ul li .sub-menu li > a.is-current-menu-link,
        .mean-container .mean-nav ul li > a.is-current-menu-link {
            color: {{ $website->menu_link_visited_color }} !important;
            -webkit-text-fill-color: {{ $website->menu_link_visited_color }} !important;
        }
    @endif
</style>
