@if($shopSetting->custom_fields_checkout)
    ...
    @if($fields)
        ...
        @foreach($fields as $value)
            ...
            echo "<label>$title{$required_label}</label><input type='$type' class='form-control custom_fields_checkout' id='$field' placeholder='{$placeholder}' name='custom_fields[$field]' $required>";
            echo "</div>";
            ?>
            <?php $i++;?>
        @endforeach
