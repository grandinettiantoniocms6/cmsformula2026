...
<main>
    <section class="section-page-header bg-light py-4 border-bottom">
        <div class="container">
            <h2 class="h3 my-0">{{ @$labels['shop-checkoutmini-invia-ordine'] }}</h2>
        </div>
    </section>
    @php
        $tot = 0;
            ...
            <div class="container">
                ...
                <div class="row">
                    <main class="col-12 col-lg-8 order-2 order-lg-1">
                        ...
                        <button class="btn btn-primary btn-block btn-lg my-3">{{ @$labels['shop-checkoutmini-invia-ordine'] }}</button>
                                                ...
                                                <table class="table table-sm my-0">
                                                    ...
                                                    @foreach ($cart as $item)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right" width="90">{!! $symbol !!} {{ number_format($productTotal,2, ',','.') }}</td>
                                                        </tr>
                                                        @php
                                                            $tot = $tot + $productTotal;
                                                ...
                                                <table class="table table-sm my-0">
                                                    ...
                                                    @if(env('PROJECT_NAME') != "Maison-Flaneur")
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right">{!! $symbol !!} <span id="sum_tax">{{ number_format(round($tot - $totNoTax, 2),2, ',','.') }}</span></td>
                                                        </tr>
                                                    @endif
            ...
            success: function (data) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        ?>
                        $('#shipping_view').html('<th>Spedizione</th><td class="text-right">{!! $symbol !!} ' + sum_total_ship_format + '</td>');
                    },
                    error: function(){}
                });
            },
