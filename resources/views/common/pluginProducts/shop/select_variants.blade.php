<?php
   ...
   if($attribute_item){
       $options = \App\Models\ShopAttributesProducts::selectRaw("shop_attributes_options.value,shop_attributes_products.id")
...
@if($attribute_item && count($options))
    <div class="product-form product-variations">
        <label class="col-3 pl-0 my-0">{{ $attribute_item->name }}: </label>
        <div class="select-box">
            <select name="first_attribute" class="form-control" id="first_attribute">
