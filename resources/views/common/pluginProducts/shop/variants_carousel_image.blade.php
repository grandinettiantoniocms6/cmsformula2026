...
<a class="d-block" title="{{ $name }}" href="{{ route("pluginProducts.detail.".\App::getLocale(), [$cat_prod_slug,$variant->slug]) }}">
    <div class="card">
        @if($cover)
            <img class="img-fluid mx-auto img-variant" src="{{ $cover }}" alt="" width="280" height="315">
        @else
            <img class="img-fluid mx-auto img-variant" src="{{ url("plugins/pluginProducts/no-image.jpg") }}" alt="" width="280" height="315">
        @endif
