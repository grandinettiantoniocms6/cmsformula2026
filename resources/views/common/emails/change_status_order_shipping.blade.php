                                                        ...
                                                        <tr>
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px; text-align: center;">
                                                                ...
                                                                @if($data['country_id'] === null)
                                                                    <p style="text-align: center!important; font-size:18px !important;">
                                                                        Lo stato dell'ordine in oggetto è cambiato in <strong>{{ $data['status']->name }}</strong>
                                                                    </p>
                                                                @else
                                                                    @if($data['country_id'] == config('config.default_country_user_it'))
                                                                        <p style="text-align: center!important; font-size:18px !important;">
                                                                            Lo stato dell'ordine in oggetto è cambiato in <strong>{{ $data['status']->name }}</strong>
                                                                        </p>
                                                                    @else
                                                                        <p style="text-align: center!important; font-size:18px !important;">
                                                                            The status of the order in question has changed to <strong>{{ $data['status']->name }}</strong>
                                                                        </p>
                                                                    @endif
                                                                @endif
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                ...
                                                                Nota: questa mail è stata inviata da un indirizzo di notifiche automatiche e non accetta messaggi in entrata. Non rispondere a questo
                                                                messaggio, grazie.
                                                            </td>
                                                        </tr>
                                                        </tbody>
