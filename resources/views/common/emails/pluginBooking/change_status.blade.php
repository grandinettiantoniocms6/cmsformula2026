                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td align="center" valign="top" id="templateHeader" data-template-container>
                            <!--[if (gte mso 9)|(IE)]>
                            <table align="center" border="0" cellspacing="0" cellpadding="0" width="600" style="width:90%;">
                                <tr>
                                    <td align="center" valign="top" width="600" style="width:90%;">
                            <![endif]-->
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                <p style="text-align: left!important; font-size:18px !important;">

                                                                {{ @$labels['booking-myarea-email-ciao'] }} <strong>{{ $data['user']->name }}</strong> , <br><br>
                                                                {{ @$labels['booking-myarea-email-la-prenot.num'] }} <strong>{{ $data['reservation']->id }}</strong> {{ @$labels['booking-myarea-email-sul-sito'] }} {{ env('PROJECT_NAME') }} {{ @$labels['booking-myarea-email-ha-nuovo-stato'] }} <strong>{!! $data['reservation']->getStatus() !!}</strong>.<br><br>
                                                                {{ @$labels['booking-myarea-email-puoi-controllare-lo-stato'] }}<br>
                                                                {{ @$labels['booking-myarea-email-a-presto'] }}<br>
                                                                {{ env('PROJECT_NAME') }}
                                                                ...
                                                                ?>
                                                                @if(env('ID_STATO_CONFERMATO_BOOKING') == $reservation->plugin_booking_status_id)
                                                                   {!! $type->email !!}
                                                                @endif
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnTextBlock" style="min-width:100%;">
                                ...
                                <tr>
                                    <td valign="top" class="mcnTextBlockInner" style="padding-top:0px;">
                                        ...
                                        <!--[if mso]>
                                        <td valign="top" width="600" style="width:90%;">
