                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                <p style="text-align: left!important; font-size:18px !important;">{{ @$labels['booking-myarea-email-ciao'] }} {{ $data['user']->first_name }},<br><br>

                                                                <h3 style="text-align: left!important">{{ @$labels['booking-myarea-email-il-tuo-pin'] }} <strong>{{ $data['pin'] }}</strong></h3>

                                                                <?php
                                                                $room = \App\Models\PluginBookingRoom::find($data['reservation']->plugin_booking_room_id);
                                                                $type = \App\Models\PluginBookingType::find($room->plugin_booking_type_id);
                                                                ?>

                                                                <!-- Testo aggiuntivo pilotato da admin -->
                                                                {!! $type->email_pin !!}

                                                                <p style="text-align: left!important; font-size:18px !important;">

                                                                {{ @$labels['booking-myarea-email-a-presto'] }}<br>
                                                                {{ @$labels['booking-myarea-email-lo-staff-di'] }}  {{ env('PROJECT_NAME') }}
                                                                </p>
