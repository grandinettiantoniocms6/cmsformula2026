                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                <p style="text-align: left!important; font-size:18px !important;">{{ @$labels['booking-myarea-email-ciao'] }} {{ $data['user']->name }}</p>
                                                                <p style="text-align: left!important; font-size:18px !important;">{{ @$labels['booking-myarea-email-prenotazione-n'] }} <strong>{{ $data['reservation']->id }}</strong>
                                                                    {{ @$labels['booking-myarea-email-cambio-stato'] }} "<strong>{!! $data['reservation']->getStatus() !!}"</strong><br>
                                                                    <br>{{ @$labels['booking-myarea-email-monitora-stato-prenotazione'] }}
                                                                </p>
                                                                ...
                                                                <table class="table table-sm font-sm" width="100%">
                                                                    <tbody>
                                                                    <tr>
                                                                        <th>{{ @$labels['booking-riassume-dal'] }}</th><br>
                                                                        <td>{{ \Carbon\Carbon::createFromFormat("Y-m-d", $reservation->date_start)->format("d/m/Y") }}
                                                                            @if($reservation->start_time)
                                                                                {{ @$labels['booking-riassume-ore'] }} {{ \Carbon\Carbon::createFromFormat("H:i:s", $reservation->start_time)->format("H:i") }}
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ \Carbon\Carbon::createFromFormat("Y-m-d", $reservation->date_end)->format("d/m/Y") }}
                                                                                @if($reservation->end_time)
                                                                                    {{ @$labels['booking-riassume-ore'] }} {{ \Carbon\Carbon::createFromFormat("H:i:s", $reservation->end_time)->format("H:i") }}
                                                                                @endif
                                                                            </td>
                                                                        </tr>
                                                                                ...
                                                                                @if($reservation_partecipants)
                                                                                    <ul class="style-1">
                                                                                        @foreach($reservation_partecipants as $partecipant)
                                                                                            <li>{{ $partecipant->first_name }} {{ $partecipant->last_name }} nato il {{ \Carbon\Carbon::createFromFormat("Y-m-d", $partecipant->birthdate)->format("d/m/Y") }}</li>
                                                                                        @endforeach
                                                                                    </ul>
                                                                                @endif
                                                                            @else
                                                                    ...
                                                                    <tr>
                                                                        <th>{{ @$labels['booking-myarea-numero-bambini'] }}</th>
                                                                        <td>
                                                                            {{ $reservation->total_qty_bimbi }}
                                                                        </td>
                                                                    </tr>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                ...
                                                                {{ @$labels['zzz'] }}Nota: questa mail è stata inviata da un indirizzo di notifiche automatiche e non accetta messaggi in entrata. Non rispondere a questo
                                                                messaggio, grazie.
                                                            </td>
                                                        </tr>
                                                        </tbody>
