                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                <p style="text-align: left!important; font-size:16px !important;">{{ @$labels['booking-myarea-email-ciao'] }} {{ $data['user']->name }},<br><br>

                                                                {{ @$labels['booking-myarea-email-lo-staff-di'] }} {{ env('PROJECT_NAME') }} {{ @$labels['booking-myarea-email-ti-ricorda-di-caricare-i-documenti'] }}

                                                                    {{ \Carbon\Carbon::createFromFormat("Y-m-d", $data['reservation']->date_start)->format("d/m/Y") }}
                                                                ...
                                                                <!-- altro testo pilotato da admin -->
                                                                {!! $type->email_sollecito !!}
                                                                </p>
