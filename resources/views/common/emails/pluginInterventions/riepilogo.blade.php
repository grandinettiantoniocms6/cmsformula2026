                                                    ...
                                                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                                                        ...
                                                        <tr>
                                                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                                                ...
                                                                ?>
                                                                @if($setting->logo)
                                                                    <img style="max-width: 220px;" src="{{ url($setting->logo) }}" alt="{{ env('PROJECT_NAME') }}" title="{{ env('PROJECT_NAME') }}">
                                                                @endif
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                ...
                                                                <br>
                                                                <h4 class="mb-4">Riepilogo Intervento</h4>
                                                                <br>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <table class="table table-borderless table-sm" width="100%">
                                                                                ...
                                                                                <tr>
                                                                                    <td>Cliente</td>
                                                                                    <td class="text-right">{{ $intervention->first_name }} {{ $intervention->last_name }}</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Indirizzo</td>
                                                                                    <td class="text-right">{{ $intervention->address }}</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Civico</td>
                                                                                    <td class="text-right">{{ $intervention->civico }}</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Frazione</td>
                                                                                    <td class="text-right">{{ $intervention->frazione }}</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Comune</td>
                                                                                    <td class="text-right">{{ $intervention->comune }}</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Provincia</td>
                                                                                    <td class="text-right">{{ $intervention->provincia }}</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Cap</td>
                                                                                    <td class="text-right">{{ $intervention->cap }}</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Cellulare</td>
                                                                                    <td class="text-right">{{ $intervention->mobile }}</td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td>Mezzo</td>
                                                                                    <td class="text-right">{{ $intervention->vehicle->name }}</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Autista</td>
                                                                                    <td class="text-right">
