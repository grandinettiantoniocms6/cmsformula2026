...
<head>
    ...
    <style type="text/css">
        ...
        h1{
            ...
            /*@editable*/font-family: "Montserrat", sans-serif;
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                <p style="text-align: center!important; font-size:18px !important;">Ciao {{ $data->name }}</p>
                                                                <h5 style="text-align: center!important">La prenotazione n.<strong>{{ $data->id }}</strong>
                                                                ...
                                                                <table class="table table-sm font-sm" width="100%">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ \Carbon\Carbon::createFromFormat("Y-m-d", $data->date_start)->format("d/m/Y") }}
                                                                            @if($data->time_start)
                                                                                alle ore {{ \Carbon\Carbon::createFromFormat("H:i", $data->time_start)->format("H:i") }}
                                                                            @endif
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th>Data di uscita:</th>
                                                                        <td>{{ \Carbon\Carbon::createFromFormat("Y-m-d", $data->date_end)->format("d/m/Y") }}
                                                                            @if($data->time_end)
                                                                                alle ore {{ \Carbon\Carbon::createFromFormat("H:i", $data->time_end)->format("H:i") }}
                                                                            @endif
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th>Numero di volo:</th>
                                                                        <td>
                                                                             {{ $data->number_flight }}
                                                                        </td>
                                                                    </tr>
                                                                ...
                                                                <table class="table table-sm font-sm" width="100%">
                                                                    ...
                                                                    Al rientro, quando avete ritirato le valigie, chiamare il numero +39 393 50 80 289 e la navetta verrà a prendervi nel punto indicato, precedentemente.<br><br>
                                                                    Buon viaggo dallo staff AutoPal.<br>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                ...
                                                                Nota: questa mail è stata inviata da un indirizzo di notifiche
                                                                automatiche e non accetta messaggi in entrata. Non rispondere a questo
                                                                messaggio, grazie.
                                                            </td>
                                                        </tr>
                                                        </tbody>
