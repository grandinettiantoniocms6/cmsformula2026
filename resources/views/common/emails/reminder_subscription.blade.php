                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                <p style="text-align: center!important; font-size:18px !important; font-family: Georgia">Ciao {{ $data['user']->name }}</p>
                                                                    {!! $data['html'] !!}
                                                                    <!-- / messaggio admin -->
                                                                    <br><br>
                                                                    <h4 class="mb-4">Abbonamenti in scadenza:</h4>
                                                                    <br>
                                                                        ...
                                                                        <table class="table table-sm font-sm" width="100%">
                                                                            ...
                                                                            <tbody>
                                                                                 @foreach($subscriptions as $subscription)
                                                                                     <?php
                                                                                     $product = \App\Models\PluginProducts::find($subscription->id);
                                                                                     if(!$product){
                                                                                         continue;
                                                                                     }
                                                                                     ?>
                                                                                     ...
                                                                                     <tr>
                                                                                         ...
                                                                                         <td>
                                                                                             {{ $subscription->nominativo }}
                                                                                         </td>
                                                                                         <td>
                                                                                             {{ \Carbon\Carbon::createFromFormat("Y-m-d", $subscription->end)->format("d/m/Y") }}
                                                                                         </td>
                                                                                     </tr>
                                                                                 @endforeach
                                                                            </tbody>
                                                                        ...
                                                                        <tbody class="mcnButtonBlockOuter">
                                                                            <tr>
                                                                                <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                                                                                    <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #000;">
                                                                                        <tbody>
                                                                                        <tr>
                                                                                            <td align="center" valign="middle" class="mcnButtonContent" style="font-size: 18px; padding: 18px;">

                                                                                                <a class="mcnButton" title="Rinnova" href="{{ route('index.autologin', $data['user']->code) }}?ids=<?php echo implode(",",$ids); ?>" target="_blank" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">
                                                                                                    RINNOVA ORA
                                                                                                </a>
                                                                                            </td>
                                                                                        </tr>
