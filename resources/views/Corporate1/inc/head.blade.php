...
<!-- css -->
<link rel="stylesheet" href="{{ url("templates/Corporate1/assets/css/bootstrap.min.css") }}">
<link rel="stylesheet" href="{{ url("templates/Corporate1/assets/css/all-fontawesome.min.css") }}">
<link rel="stylesheet" href="{{ url("templates/Corporate1/assets/css/animate.min.css") }}">
<link rel="stylesheet" href="{{ url("templates/Corporate1/assets/css/magnific-popup.min.css") }}">
<link rel="stylesheet" href="{{ url("templates/Corporate1/assets/css/owl.carousel.min.css") }}">
<link rel="stylesheet" href="{{ url("templates/Corporate1/assets/css/nice-select.min.css") }}">
<link rel="stylesheet" href="{{ url("templates/Corporate1/assets/css/style.css") }}">
