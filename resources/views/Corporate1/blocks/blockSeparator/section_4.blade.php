                ...
                <div class="container-fluid page-container">
                    <div class="row mt-md-3 p-5">
                        <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-5">
                            <div class="section-title wow animate__fadeInUp" data-wow-duration=".3s" style="margin-left: 40px;">
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-7 d-flex justify-content-center wow animate__fadeInRight" data-wow-duration=".3s">
                            <video style="max-width: 100%;" width="auto" height="{{ $value->video_height }}" autoplay muted loop playsinline>
                            ...
                            <div style="position: absolute; bottom: 20px;">
                                @if(trim($button[\App::getLocale()])!="")
                                    <a target="{{ $type_href }}" class="btn wow animate__fadeInRight" data-wow-duration="1.5s" href="{{ $url }}">{{ $button[\App::getLocale()] }}</a>
                                @endif
                            </div>
                        </div>
                    </div>
