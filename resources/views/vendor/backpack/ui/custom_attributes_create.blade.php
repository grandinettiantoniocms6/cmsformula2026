...
@push('after_styles')
    ...
    <style>
        ...
        .enhanced-custom-attributes-create-header {
        ...
        .enhanced-custom-attributes-create-header .page-title {
            display: flex;
        ...
        .enhanced-custom-attributes-create-header .page-title small {
            color: #607197;
            font-weight: 600;
        }

        .enhanced-custom-attributes-create-header .page-title small a {
            color: #3b5d9f;
            font-weight: 700;
        }

        .enhanced-custom-attributes-create-header .page-title small a:hover {
            color: #2b4d8d;
...
@section('header')
    <div class="{{ $isModernAdminTemplate ? 'enhanced-custom-attributes-create-header' : '' }}">
