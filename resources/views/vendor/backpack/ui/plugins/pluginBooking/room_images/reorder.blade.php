...
<div class="container-fluid">
    <h2>
        ...
        @if ($crud->hasAccess('list'))
          <small><a href="#" onclick="history.back()" class="d-print-none font-sm"><i class="la la-angle-double-left"></i> {{ trans('backpack::crud.back_to_all') }} <span>{{ $crud->entity_name_plural }}</span></a></small>
        @endif
    </h2>
</div>
@endsection
...
function tree_element($entry, $key, $all_entries, $crud)
{
    if (! isset($entry->tree_element_shown)) {
        ...
        $url = url(object_get($entry, $crud->get('reorder.label')));
        echo '<div><span class="disclose"><span></span></span><img src="'.$url.'" width="120"></div>';
