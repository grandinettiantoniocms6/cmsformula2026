          ...
          <div class="col-sm-6">
            @if ( $crud->buttons()->where('stack', 'top')->count() ||  $crud->exportButtons())
              <div class="d-print-none {{ $crud->hasAccess('create')?'with-border':'' }}">
                ...
                @if(\request()->has('ko'))
                      <a href="{{ backpack_url('plugin-booking-reservation') }}" class="btn btn-success">Prenotazioni in corso</a>
                @else
                      <a href="{{ backpack_url('plugin-booking-reservation') }}?ko=1" class="btn btn-danger">Prenotazioni annullate</a>
                @endif
