                    ...
                    <div class="form-group col-md-2">
                        ...
                        <select class="form-control" name="condition_discount[]" id="condition_discount_{{ $item->id }}">
                            ...
                            @if($item->condition_discount == 1)
                                <option value="1" selected>Numero giorni</option>
                                <option value="2">Numero partecipanti</option>
                            @else
                                @if($item->condition_discount == 2)
                                    <option value="1">Numero giorni</option>
                                    <option value="2" selected>Numero partecipanti</option>
                                @else
                                    <option value="1">Numero giorni</option>
                                    <option value="2">Numero partecipanti</option>
                                @endif
