...
@push('after_styles')
    ...
    <style>
        .plugin-products-create-header-shell{background:linear-gradient(130deg,#fff 0%,#f4f8ff 100%);border:1px solid #dbe6fb;border-radius:14px;padding:14px 16px;box-shadow:0 8px 22px rgba(24,43,81,.08);margin-bottom:12px}
        .plugin-products-create-header-shell .page-title{display:flex;align-items:baseline;gap:10px;flex-wrap:wrap;color:#182f59;font-weight:700}
...
@section('header')
    <div class="plugin-products-create-header-shell"><h3 class="page-title mb-0">
