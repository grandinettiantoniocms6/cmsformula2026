...
@section('after_styles')
  ...
  <style>
    .plugin-products-list-header-shell {
    ...
    .plugin-products-list-header-shell .page-title {
      color: #182f59;
      font-weight: 700;
      display: flex;
    ...
    .plugin-products-list-header-shell #datatable_info_stack {
      color: #5e7097;
      font-weight: 600;
      font-size: .9rem;
    }

    .plugin-products-list-toolbar {
      background: #f8faff;
    ...
    .plugin-products-list-toolbar .btn,
    .plugin-products-list-toolbar .dropdown .btn {
      border-radius: 9px;
      font-weight: 700;
      box-shadow: none;
    }
    ...
    #crudTable tbody tr:nth-child(odd) { background: #fcfdff; }
    #crudTable tbody tr:nth-child(even) { background: #f6f8fc; }
    #crudTable tbody tr:hover { background: #eaf0ff !important; }
