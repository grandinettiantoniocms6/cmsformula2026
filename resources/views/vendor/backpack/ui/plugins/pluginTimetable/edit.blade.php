...
@push('after_styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('packages/summernote/dist/summernote-bs4.css') }}"/>
    <style>
...
@push('after_scripts')
    <script type="text/javascript" src="{{ asset('packages/summernote/dist/summernote-bs4.min.js') }}"></script>

    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11/dist/sweetalert2.min.js"></script>
    @include(backpack_view('plugins.pluginTimetable.js'))
