        ...
        <table class="table table-sm table-bordered table-striped text-left">
            ...
            @if($order->code_coupon)
                ...
                <tr>
                    ...
                    <td class="text-right"><strong>{{ ($order->total_tax - $order->total_coupon) + $order->total_extra + $order->total_shipping_tax + $order->total_payment_tax.' '.$order->currency->name }}</strong></td>
                </tr>
            ...
            @else
                ...
                <tr>
                    <th class="text-right" colspan="3">Totale:</th>
                    <td class="text-right"><strong>{{ number_format($order->total_tax + $order->total_shipping_tax + $order->total_payment_tax + $order->total_extra, 2,",",".").' '.$order->currency->name }}</strong></td>
                </tr>
