                ...
                <div class="card-body d-flex flex-column">
                    <div class="row">
                        ...
                        <div class="col-auto">
                            ...
                            ?>
                            <div class="card text-center line-height-xs mb-0">
                                <div class="font-xs text-uppercase px-4 pt-1">{{ $day_d }}</div>
                                <div class="py-1 font-5xl px-4">{{ \Carbon\Carbon::now()->format("d") }}</div>
                                <div class="font-xs text-uppercase px-4">{{ $day_m }}</div>
                                <div class="font-xs py-1 px-4 pb-1">{{ \Carbon\Carbon::now()->format("Y") }}</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-dashboard">
                    ...
                    <div class="card-body flex-grow-0">
                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                <h4 class="font-4xl mb-0 line-height-sm">€ {{ number_format($order_sum,2,",",".") }}</h4>
                                <div class="text-uppercase">Ad oggi</div>
                            </div>
                            <div class="col-auto">
                                <div class="media align-items-center">
                                    <i class="hgi hgi-stroke hgi-sharp hgi-delivery-box-01 font-5xl"></i>
                            ...
                            <div class="col-auto">
                                <div class="media align-items-center">
                                    <i class="hgi hgi-stroke hgi-shopping-cart-check-in-02 font-5xl"></i>
                                    <div class="media-body ml-3">
                    ...
                    <div class="card-body pt-0 flex-grow-1">
                        ...
                        @if(count($list))
                            <h5 class="line-height-xs mt-3">Ultimi ordini</h5>
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <div class="card-body">
                                            ...
                                            ?>
                                            @if($list)
                                                <table class="table table-borderless line-height-sm mt-auto mb-0" id="table-top-clienti">
                                                    <tbody>
                                                    <tr>
                                                        <td></td>
                                                        <td>
