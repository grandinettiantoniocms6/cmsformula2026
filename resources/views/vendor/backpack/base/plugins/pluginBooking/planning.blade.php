...
@section('content')
    ...
    <?php
    $types = \App\Models\PluginBookingType::where("is_visible_calendar", 1)->orderBy("name", "asc")->get();
    ?>

    <form method="get" action="#">
        <div class="form-group">
            <select name="type" id="type" class="form-control" onchange="change_type()">
...
@section('after_scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                defaultView: 'resourceTimeGrid', //dayGridMonth
                nowIndicator: true,
                views: {},
                ...
                header: {
                    ...
                    center: 'title',
                    right: 'dayGridMonth,timeGridWeek,timeGridDay,resourceTimeGrid'
                },
                views: {
                    resourceTimeGrid: {
                        type: 'resourceTimeGrid',
                       // duration: { days: 3 },
                        buttonText: 'Panoramica',
                    }
                },
                buttonText: {
                    today: 'Oggi',
                ...
                eventSources: [{
                    url: '{{ route('pluginBookings.events') }}?type={{ \request()->get('type') }}'
                }],
                ...
                dateClick: function(date, jsEvent, view) {
                    window.location.href = "/admin/plugin-booking-reservation/create?date_start="+date.dateStr;
                },
                select: function(info) {
                    window.location.href = "/admin/plugin-booking-reservation/create?date_start="+info.startStr+"&date_end="+info.endStr;
                },
                eventClick: function(info) {
                    var id = info.event.id;
                    console.log(info);
                    window.location.href = "/admin/plugin-booking-reservation/"+id+"/edit";
                },
    ...
    <script type="text/javascript">
        ...
        function change_type(){
            var id = $("#type").val();
            window.location.href = "/admin/pluginBookings/planning?type="+id;
        }
