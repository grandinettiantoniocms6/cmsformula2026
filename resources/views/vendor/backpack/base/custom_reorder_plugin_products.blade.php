...
<div class="container-fluid">
    <h2>
        ...
        @if ($crud->hasAccess('list'))
          <small><a href="{{ url($crud->route) }}?id={{ request()->get('id') }}" class="d-print-none font-sm"><i class="la la-angle-double-left"></i> {{ trans('backpack::crud.back_to_all') }} <span>{{ $crud->entity_name_plural }}</span></a></small>
        @endif
    </h2>
</div>
@endsection
