...
@include('crud::fields.inc.wrapper_start')
    ...
    <div class="d-flex align-items-center" style="height:38px">
        <label class="switch switch-lg switch-label switch-pill switch-success mb-0" id="{{ $field['name'] }}-switch">
            <input type="hidden" name="{{ $field['name'] }}" id="{{ $field['name'] }}" value="{{ old(square_brackets_to_dots($field['name'])) ?? $field['value'] ?? $field['default'] ?? 0 }}">
