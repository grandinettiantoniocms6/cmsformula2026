            ...
            <div class="row no-gutters future-login-shell">
                <div class="col-lg-6">
                    <div class="future-login-side">
                        <span class="future-login-badge"><i class="la la-shield"></i> Nuova Password</span>
                        ...
                        <div class="future-login-title">Imposta la tua nuova password di accesso.</div>
                        <p class="future-login-text">Passo 2: inserisci email, nuova password e conferma per completare il ripristino.</p>
                        <ul class="future-login-points">
                            <li><i class="la la-check-circle"></i> Token di sicurezza valido</li>
                            <li><i class="la la-check-circle"></i> Password aggiornata subito</li>
                            <li><i class="la la-check-circle"></i> Accesso immediato al pannello</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6 future-login-form-col">
                    <div class="future-login-form-wrap">
                        ...
                        <div class="future-login-subtitle">Passo 2: scegli le nuove credenziali.</div>
                        @if (session('status'))
                        ...
                        <form role="form" method="POST" action="{{ route('backpack.auth.password.reset') }}">
                            ...
                            <div class="form-group mb-3">
                                <button type="submit" class="btn btn-block btn-dark">{{ trans('backpack::base.change_password') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-9 col-lg-6">
                <div class="auth-reset-shell">
                    <h3 class="text-center auth-reset-title">Nuova Password</h3>
