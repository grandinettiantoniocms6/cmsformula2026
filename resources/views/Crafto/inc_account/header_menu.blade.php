...
<header class="header-with-topbar">
    ...
    <nav class="navbar navbar-expand-lg responsive-sticky crafto-inc-account-nav" style="background-color: {{ $headerBackgroundCss }}!important; height: {{ $menubarHeightCss }}!important;">

    @else
    <nav class="navbar navbar-expand-lg crafto-inc-account-nav" style="background-color: {{ $headerBackgroundCss }}!important; height: {{ $menubarHeightCss }}!important;">
    @endif
            ...
            <div class="container-fluid">
                ...
                <style>
                    ...
                    @media only screen and (max-width: 991px) {
                        ...
                        header.header-with-topbar .crafto-inc-account-nav,
                        header.sticky .crafto-inc-account-nav,
                        header.sticky.sticky-active .crafto-inc-account-nav {
                        ...
                        header.header-with-topbar .crafto-inc-account-nav > .container-fluid,
                        header.sticky .crafto-inc-account-nav > .container-fluid,
                        header.sticky.sticky-active .crafto-inc-account-nav > .container-fluid {
                            height: {{ $menubarHeightCss }} !important;
                            min-height: {{ $menubarHeightCss }} !important;
                            max-height: {{ $menubarHeightCss }} !important;
                        ...
                        header.header-with-topbar .crafto-inc-account-nav .navbar-brand,
                        header.sticky .crafto-inc-account-nav .navbar-brand,
                        header.sticky .crafto-inc-account-nav.disable-fixed .navbar-brand,
                        header.sticky .crafto-inc-account-nav.fixed-header .navbar-brand,
                        header.sticky.sticky-active .crafto-inc-account-nav .navbar-brand {
                        ...
                        header.header-with-topbar .crafto-inc-account-nav .navbar-brand .default-logo,
                        header.header-with-topbar .crafto-inc-account-nav .navbar-brand .alt-logo,
                        header.sticky .crafto-inc-account-nav .navbar-brand .default-logo,
                        header.sticky .crafto-inc-account-nav .navbar-brand .alt-logo,
                        header.sticky.sticky-active .crafto-inc-account-nav .navbar-brand .default-logo,
                        header.sticky.sticky-active .crafto-inc-account-nav .navbar-brand .alt-logo {
                        ...
                        header.header-with-topbar .crafto-inc-account-nav .navbar-brand .mobile-logo,
                        header.sticky .crafto-inc-account-nav .navbar-brand .mobile-logo,
                        header.sticky.sticky-active .crafto-inc-account-nav .navbar-brand .mobile-logo {
                        ...
                        header.header-with-topbar .crafto-inc-account-nav .navbar-collapse,
                        header.sticky .crafto-inc-account-nav .navbar-collapse,
                        header.sticky.sticky-active .crafto-inc-account-nav .navbar-collapse {
                            z-index: 1200;
                            overflow: visible !important;
                            background-color: {{ $website->mobile_menu_bgcolor ?: $mobileStickyBackgroundCss }} !important;
                        }

                        header.header-with-topbar .crafto-inc-account-nav .navbar-collapse.collapsing,
                        header.sticky .crafto-inc-account-nav .navbar-collapse.collapsing,
                        header.sticky.sticky-active .crafto-inc-account-nav .navbar-collapse.collapsing {
                            overflow: hidden !important;
                            background-color: {{ $website->mobile_menu_bgcolor ?: $mobileStickyBackgroundCss }} !important;
                            transition: height 0.25s ease !important;
                        }

                        header.header-with-topbar .crafto-inc-account-nav .navbar-collapse .navbar-nav,
                        header.sticky .crafto-inc-account-nav .navbar-collapse .navbar-nav,
                        header.sticky.sticky-active .crafto-inc-account-nav .navbar-collapse .navbar-nav {
                            background-color: {{ $website->mobile_menu_bgcolor ?: $mobileStickyBackgroundCss }} !important;
                        }

                        header.header-with-topbar .crafto-inc-account-nav .navbar-toggler,
                        header.sticky .crafto-inc-account-nav .navbar-toggler,
                        header.sticky.sticky-active .crafto-inc-account-nav .navbar-toggler {
