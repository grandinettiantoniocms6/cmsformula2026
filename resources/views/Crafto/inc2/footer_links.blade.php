<nav class="nav nav-links">
    ...
    @if($website->photo_credits)
            ...
            ?>
        <a class="nav-link" href="{{ $website->link_credits }}" target="_blank" title="Sito realizzato da Webisland.it"><img class="img-fluid mx-auto" alt="Sito realizzato da webisland.it" src="{{ url($website->photo_credits) }}" @if(env('LOCAL') == 0) width="{{ $width }}" height="{{ $height }}" @endif></a>
    @endif
</nav>
