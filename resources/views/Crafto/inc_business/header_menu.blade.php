...
<header class="header-with-topbar">
    ...
    <nav class="navbar navbar-expand-lg header-transparent bg-transparent header-reverse crafto-inc-busines-nav" >
    @else
    <nav class="navbar navbar-expand-lg header-transparent bg-transparent crafto-inc-busines-nav" >
    @endif
        ...
        <div class="container-fluid">
            ...
            <style>
                header.sticky .crafto-inc-busines-nav,
                header.sticky.sticky-active .crafto-inc-busines-nav {
                    background-color: {{ $headerBackgroundCss }} !important;
                }

                header.sticky .crafto-inc-busines-nav > .container-fluid,
                header.sticky.sticky-active .crafto-inc-busines-nav > .container-fluid {
                    background-color: {{ $headerBackgroundCss }} !important;
                }
                ...
                @media only screen and (max-width: 1450px) {
                    ...
                    .crafto-inc-busines-nav > .container-fluid > .col-auto.col-lg-2 {
                ...
                @media only screen and (max-width: 1450px) {
                    ...
                    header.header-with-topbar .crafto-inc-busines-nav,
                    header.sticky .crafto-inc-busines-nav,
                    header.sticky.sticky-active .crafto-inc-busines-nav {
                    ...
                    header.header-with-topbar .crafto-inc-busines-nav > .container-fluid,
                    header.sticky .crafto-inc-busines-nav > .container-fluid,
                    header.sticky.sticky-active .crafto-inc-busines-nav > .container-fluid {
                        height: {{ $menubarHeightCss }} !important;
                        min-height: {{ $menubarHeightCss }} !important;
                    ...
                    header.header-with-topbar .crafto-inc-busines-nav .navbar-brand,
                    header.sticky .crafto-inc-busines-nav .navbar-brand,
                    header.sticky .crafto-inc-busines-nav.disable-fixed .navbar-brand,
                    header.sticky .crafto-inc-busines-nav.fixed-header .navbar-brand,
                    header.sticky.sticky-active .crafto-inc-busines-nav .navbar-brand {
                    ...
                    header.header-with-topbar .crafto-inc-busines-nav .navbar-brand .default-logo,
                    header.header-with-topbar .crafto-inc-busines-nav .navbar-brand .alt-logo,
                    header.sticky .crafto-inc-busines-nav .navbar-brand .default-logo,
                    header.sticky .crafto-inc-busines-nav .navbar-brand .alt-logo,
                    header.sticky.sticky-active .crafto-inc-busines-nav .navbar-brand .default-logo,
                    header.sticky.sticky-active .crafto-inc-busines-nav .navbar-brand .alt-logo {
                    ...
                    header.header-with-topbar .crafto-inc-busines-nav .navbar-brand .mobile-logo,
                    header.sticky .crafto-inc-busines-nav .navbar-brand .mobile-logo,
                    header.sticky.sticky-active .crafto-inc-busines-nav .navbar-brand .mobile-logo {
                        display: block !important;
                    ...
                    header.header-with-topbar .crafto-inc-busines-nav .navbar-collapse,
                    header.sticky .crafto-inc-busines-nav .navbar-collapse,
                    header.sticky.sticky-active .crafto-inc-busines-nav .navbar-collapse {
                        z-index: 1200;
                        overflow: visible !important;
                        background-color: {{ $website->mobile_menu_bgcolor ?: $mobileStickyBackgroundCss }} !important;
                    }

                    header.header-with-topbar .crafto-inc-busines-nav .navbar-collapse.collapsing,
                    header.sticky .crafto-inc-busines-nav .navbar-collapse.collapsing,
                    header.sticky.sticky-active .crafto-inc-busines-nav .navbar-collapse.collapsing {
                        overflow: hidden !important;
                        background-color: {{ $website->mobile_menu_bgcolor ?: $mobileStickyBackgroundCss }} !important;
                        transition: height 0.25s ease !important;
                    }

                    header.header-with-topbar .crafto-inc-busines-nav .navbar-collapse .navbar-nav,
                    header.sticky .crafto-inc-busines-nav .navbar-collapse .navbar-nav,
                    header.sticky.sticky-active .crafto-inc-busines-nav .navbar-collapse .navbar-nav {
                        background-color: {{ $website->mobile_menu_bgcolor ?: $mobileStickyBackgroundCss }} !important;
                    }

                    header.header-with-topbar .crafto-inc-busines-nav .navbar-toggler,
                    header.sticky .crafto-inc-busines-nav .navbar-toggler,
                    header.sticky.sticky-active .crafto-inc-busines-nav .navbar-toggler {
