...
<script src="{{ url('templates/Crafto/js/vendor/isotopepkgd.js') }}" defer></script>
<script src="{{ url('templates/Crafto/js/vendor/imagesloaded.pkgd.js') }}" defer></script>
...
<script  src="{{ url('templates/Webshop/js/jquery.js') }}" defer></script>
<script  src="{{ url('templates/Webshop/js/vendors.min.js') }}" defer></script>
<script  src="{{ url('templates/Webshop/js/main.js') }}" defer></script>
