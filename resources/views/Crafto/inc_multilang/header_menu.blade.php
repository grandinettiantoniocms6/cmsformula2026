...
<header class="header-with-topbar">
    ...
    <nav class="navbar navbar-expand-lg header-reverse crafto-inc-multilang-nav" style="background-color: {{ $headerBackgroundCss }}!important; height: {{ $menubarHeightCss }}!important;">

    @else
    <nav class="navbar navbar-expand-lg crafto-inc-multilang-nav" style="background-color: {{ $headerBackgroundCss }}!important; height: {{ $menubarHeightCss }}!important;">
    @endif
            ...
            <div class="container-fluid">
                <div class="col-auto">
                    ...
                    <a class="navbar-brand" href="/">
                        @if($website->logo)
                            <?php
                            $logoDimensions = null;
                            $logoPath = public_path(ltrim($website->logo, '/'));
                            if(is_file($logoPath)){
                                $logoDimensions = @getimagesize($logoPath);
                            }
                            ?>
                            <img src="{{ url($website->logo) }}" class="default-logo" alt="{{ $website->title }}" @if($logoDimensions) width="{{ $logoDimensions[0] }}" height="{{ $logoDimensions[1] }}" @endif loading="eager" fetchpriority="high" decoding="async">
                            <img src="{{ url($website->logo) }}" class="alt-logo" alt="{{ $website->title }}" @if($logoDimensions) width="{{ $logoDimensions[0] }}" height="{{ $logoDimensions[1] }}" @endif loading="eager" fetchpriority="high" decoding="async">

                            @if($website->logo2)
                                <?php
                                $mobileLogoDimensions = null;
                                $mobileLogoPath = public_path(ltrim($website->logo2, '/'));
                                if(is_file($mobileLogoPath)){
                                    $mobileLogoDimensions = @getimagesize($mobileLogoPath);
                                }
                                ?>
                                <img src="{{ url($website->logo2) }}" class="mobile-logo" alt="{{ $website->title }}" @if($mobileLogoDimensions) width="{{ $mobileLogoDimensions[0] }}" height="{{ $mobileLogoDimensions[1] }}" @endif loading="eager" fetchpriority="high" decoding="async">
                            @else
                                <img src="{{ url($website->logo) }}" class="mobile-logo" alt="{{ $website->title }}" @if($logoDimensions) width="{{ $logoDimensions[0] }}" height="{{ $logoDimensions[1] }}" @endif loading="eager" fetchpriority="high" decoding="async">
                            @endif
                        @else
                            {{ $website->title }}
                        @endif
                ...
                <style>
                    ...
                    @media only screen and (max-width: 991px) {
                        ...
                        header.header-with-topbar .crafto-inc-multilang-nav,
                        header.sticky .crafto-inc-multilang-nav,
                        header.sticky.sticky-active .crafto-inc-multilang-nav {
                        ...
                        header.header-with-topbar .crafto-inc-multilang-nav > .container-fluid,
                        header.sticky .crafto-inc-multilang-nav > .container-fluid,
                        header.sticky.sticky-active .crafto-inc-multilang-nav > .container-fluid {
                            height: {{ $menubarHeightCss }} !important;
                            min-height: {{ $menubarHeightCss }} !important;
                            max-height: {{ $menubarHeightCss }} !important;
                        ...
                        header.header-with-topbar .crafto-inc-multilang-nav .navbar-brand,
                        header.sticky .crafto-inc-multilang-nav .navbar-brand,
                        header.sticky .crafto-inc-multilang-nav.disable-fixed .navbar-brand,
                        header.sticky .crafto-inc-multilang-nav.fixed-header .navbar-brand,
                        header.sticky.sticky-active .crafto-inc-multilang-nav .navbar-brand {
                        ...
                        header.header-with-topbar .crafto-inc-multilang-nav .navbar-brand .default-logo,
                        header.header-with-topbar .crafto-inc-multilang-nav .navbar-brand .alt-logo,
                        header.sticky .crafto-inc-multilang-nav .navbar-brand .default-logo,
                        header.sticky .crafto-inc-multilang-nav .navbar-brand .alt-logo,
                        header.sticky.sticky-active .crafto-inc-multilang-nav .navbar-brand .default-logo,
                        header.sticky.sticky-active .crafto-inc-multilang-nav .navbar-brand .alt-logo {
                        ...
                        header.header-with-topbar .crafto-inc-multilang-nav .navbar-brand .mobile-logo,
                        header.sticky .crafto-inc-multilang-nav .navbar-brand .mobile-logo,
                        header.sticky.sticky-active .crafto-inc-multilang-nav .navbar-brand .mobile-logo {
                        ...
                        header.header-with-topbar .crafto-inc-multilang-nav .navbar-collapse,
                        header.sticky .crafto-inc-multilang-nav .navbar-collapse,
                        header.sticky.sticky-active .crafto-inc-multilang-nav .navbar-collapse {
                            z-index: 1200;
                            overflow: visible !important;
                            background-color: {{ $website->mobile_menu_bgcolor ?: $mobileStickyBackgroundCss }} !important;
                        }

                        header.header-with-topbar .crafto-inc-multilang-nav .navbar-collapse.collapsing,
                        header.sticky .crafto-inc-multilang-nav .navbar-collapse.collapsing,
                        header.sticky.sticky-active .crafto-inc-multilang-nav .navbar-collapse.collapsing {
                            overflow: hidden !important;
                            background-color: {{ $website->mobile_menu_bgcolor ?: $mobileStickyBackgroundCss }} !important;
                            transition: height 0.25s ease !important;
                        }

                        header.header-with-topbar .crafto-inc-multilang-nav .navbar-collapse .navbar-nav,
                        header.sticky .crafto-inc-multilang-nav .navbar-collapse .navbar-nav,
                        header.sticky.sticky-active .crafto-inc-multilang-nav .navbar-collapse .navbar-nav {
                            background-color: {{ $website->mobile_menu_bgcolor ?: $mobileStickyBackgroundCss }} !important;
                        }

                        header.header-with-topbar .crafto-inc-multilang-nav .navbar-toggler,
                        header.sticky .crafto-inc-multilang-nav .navbar-toggler,
                        header.sticky.sticky-active .crafto-inc-multilang-nav .navbar-toggler {
