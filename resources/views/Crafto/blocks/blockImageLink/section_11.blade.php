            ...
            @foreach($array as $value)
                ...
                <div class="row space-{{ $item->pb }}">
                    @if($perc == 0)
                        ...
                        <!-- secondo item -->
                        <div id="second" class="col-lg-7 order-2 order-lg-1 wow animate__fadeInUp" data-wow-duration=".3s" style="background-color: {{ $value->bgcolor }};">
                            <div class="card-body">
                                @if(trim($value->icon) != "")
                        ...
                        <div class="col-lg-5 img-dx order-1 order-lg-2 wow animate__fadeInDown" data-wow-duration=".3s">
                            @if(trim($foto) != "")
                                <img style="margin-right: 0px!important;" class="img-fluid mx-auto" src="{{ $foto }}" alt="{{ $title[\App::getLocale()] }}" loading="lazy">
                            @endif
                        </div>
