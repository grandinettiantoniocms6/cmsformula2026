            ...
            @foreach($array as $value)
                ...
                <div class="row space-{{ $item->pb }}">
                    @if($perc == 0)
                        ...
                        <!-- secondo item -->
                        <div class="col-lg-8 order-2 order-lg-1 wow animate__fadeInUp" data-wow-duration=".3s" style="background-color: {{ $value->bgcolor }}; padding: 5px;">
                            <div class="card-body">
                                @if(trim($value->icon) != "")
                                ...
                                @if(trim($title[\App::getLocale()])!="")
                                    <h3 class="title" style="color: {{ $value->txtcolor }}; margin-top: 5px;">{{ $title[\App::getLocale()] }}</h3>
                                @endif
                    ...
                    @else
                        ...
                        <!-- primo item -->
                        <div id="second20" class="col-lg-4 mb-4 img-sx wow animate__fadeInUp" data-wow-duration=".3s">
                            @if(trim($foto) != "")
                                <img class="img-fluid mx-auto" src="{{ $value->foto }}" alt="{{ $title[\App::getLocale()] }}" loading="lazy">
                            @endif
                        </div>

                        <div class="col-lg-8 wow animate__fadeInDown" data-wow-duration=".3s" style="background-color: {{ $value->bgcolor }}; padding: 5px;">
                            <div class="card-body">
                                @if(trim($value->icon) != "")
                                    <div class="icon" style="color: {{ $value->txtcolor }}; margin-top: 5px;">
                                        {!! $value->icon !!}
