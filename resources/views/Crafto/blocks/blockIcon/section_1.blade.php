        ...
        <div class="row row-cols-1 row-cols-lg-3 row-cols-md-2 justify-content-center">
            ...
            @if($array)
                @foreach($array as $value)
                    ...
                    <div class="col-lg-{{ $item->col }} icon-with-text-style-03 md-mb-30px transition-inner-all" style="background-color: {{ $value->bgcolor }}!important;" data-anime='{"translateX": [50, 0], "opacity": [0,1], "duration": 800, "staggervalue": 300, "easing": "easeOutQuad" }'>
