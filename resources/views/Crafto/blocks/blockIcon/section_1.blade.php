...
<section class="pt-{{ $item->pt }} pb-{{ $item->pb }}" style="background-color: {{ $item->bg_section_icon }}!important;" data-anime='{"translateX": [-50, 0], "opacity": [0,1], "duration": 800, "staggervalue": 300, "easing": "easeOutQuad" }' >
