<section class="block-contact-map" id="block-contact-map-{{ $value->block_id }}" style="margin-top: {{ $item->margin_top }}px; margin-bottom: {{ $item->margin_bottom }}px;" data-anime='{"translateX": [50, 0], "opacity": [0,1], "duration": 800, "staggervalue": 300, "easing": "easeOutQuad" }'>
    <div class="container-fluid px-0 overflow-hidden">
        <div class="row gx-0 align-items-center">
            <div class="col-lg-6 order-2 order-lg-1 wow animate__fadeInUp" data-wow-duration=".3s">
                <img src="{{ $foto }}" alt="{{ $title[\App::getLocale()] }}" class="card-img" loading="lazy">
            </div>
                    ...
                    <ul class="list-unstyled address">
                        ...
                        @if($phone1)
                            <li class="d-flex mb-1">
                                ...
                                <div style="color: {{ $value->color_txt }};"><a href="tel:{{ $phone1 }}">{{ $phone1 }}</a></div>
                            </li>
                        @endif
                        @if($phone2)
                            <li class="d-flex mb-1">
                                <span class="me-2"><i class="fas fa-phone" style="color: {{ $value->color_txt }};"></i></span>
                                <div style="color: {{ $value->color_txt }};"><a href="tel:{{ $phone2 }}">{{ $phone2 }}</a></div>
                            </li>
                        @endif
                        @if($phone3)
                            <li class="d-flex mb-1">
                                <span class="me-2"><i class="fas fa-phone" style="color: {{ $value->color_txt }};"></i></span>
                                <div style="color: {{ $value->color_txt }};"><a href="tel:{{ $phone3 }}">{{ $phone3 }}</a></div>
                            </li>
                        @endif
                        @if($fax)
                            <li class="d-flex mb-1">
                        ...
                        @if($email1)
                            <li class="d-flex mb-1">
                                ...
                                <div style="color: {{ $value->color_txt }};"><a href="mailto:{{ $email1 }}">{{ $email1 }}</a></div>
                            </li>
                        @endif
                        @if($email2)
                            <li class="d-flex mb-1">
                                <span class="me-2"><i class="far fa-envelope" style="color: {{ $value->color_txt }};"></i></span>
                                <div style="color: {{ $value->color_txt }};"><a href="mailto:{{ $email2 }}">{{ $email2 }}</a></div>
                            </li>
                        @endif
                        @if($email3)
                            <li class="d-flex mb-1">
                                <span class="me-2"><i class="far fa-envelope" style="color: {{ $value->color_txt }};"></i></span>
                                <div style="color: {{ $value->color_txt }};"><a href="mailto:{{ $email3 }}">{{ $email3 }}</a></div>
                            </li>
                        @endif
                        @if($pec)
                            <li class="d-flex mb-1">
