...
<section class="pt-0 block-referenze style-{{ $item->style }}" data-anime='{"translateX": [50, 0], "opacity": [0,1], "duration": 800, "staggervalue": 300, "easing": "easeOutQuad" }'>
    ...
    <div class="{{ $item->fullwidth }}">
        <div class="col-12 filter-content">
            <ul class="portfolio-transform portfolio-wrapper grid-loading grid grid-{{ $item->col }}col xxl-grid-{{ $item->col }}col xl-grid-{{ $item->col }}col lg-grid-{{ $item->col }}col md-grid-2col sm-grid-2col xs-grid-1col gutter-large text-center" data-anime='{"translateX": [-50, 0], "opacity": [0,1], "duration": 800, "staggervalue": 300, "easing": "easeOutQuad" }'>
                ...
                @foreach($array as $value)
                        ...
                        <li class="grid-item selected {{ \Str::slug($category[\App::getLocale()], '-')  }}">
                                            ...
                                            <div class="portfolio-image overflow-hidden">
                                                ...
                                                @if(trim($button[\App::getLocale()])!="")
                                                    <div class="caption bg-white border-radius-4px text-uppercase alt-font">
                                                        <div class="text-dark-gray fw-600 lh-12 d-block"><span>{{ $title[\App::getLocale()] }}</span></div>
                                                        <div class="fs-12 lh-initial text-medium-gray">
