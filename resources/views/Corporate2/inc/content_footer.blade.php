@include('Corporate2.engine_footer_modals')
<?php  $position = "footer"; ?>
                ...
                <div class="row align-items-center">
                    <div class="col-lg">
                        ...
                        @if($website->title_footer_1)
                            <span>{{ $website->dati }} | <a href="#" data-bs-toggle="modal" data-bs-target="#footer_1">{{ $website->title_footer_1 }}</a></span>
                        @else
                            <span>{{ $website->dati }}</span>
                        @endif
                    ...
                    <div class="col-lg-auto">
                        @include('Corporate2.inc.footer_links')
                    </div>
                </div>
            </div>
        </div>
