            ...
            @foreach($array as $value)
                ...
                <div class="row space-{{ $item->pb }}">
                    @if($perc == 0)
                        ...
                        <!-- secondo item -->
                        <div id="second" class="col-lg-12 order-2 order-lg-1 img-sx wow animate__fadeInUp" data-wow-duration=".3s">
                            @if(trim($value->foto) != "")
                                <img class="img-fluid mx-auto" src="{{ $value->foto }}" alt="{{ $title[\App::getLocale()] }}" loading="lazy">
                            @endif
                        </div>
                        <div class="col-lg-12 order-1 order-lg-2 wow animate__fadeInDown" data-wow-duration=".3s" style="background-color: {{ $value->bgcolor }};">
                            <div class="card-body">
                                @if(trim($value->icon) != "")
                    ...
                    @else
                        ...
                        <!-- primo item -->
                        <div class="col-lg-12 wow animate__fadeInUp" data-wow-duration=".3s" style="background-color: {{ $value->bgcolor }};">
                            <div class="card-body">
                                @if(trim($value->icon) != "")
                                    <div class="icon" style="color: {{ $value->txtcolor }}; margin-top: 50px;">
                                        {!! $value->icon !!}
                        ...
                        <div class="col-lg-12 img-dx wow animate__fadeInDown" data-wow-duration=".3s">
                            @if(trim($value->foto) != "")
                                <img class="img-fluid mx-auto" src="{{ $value->foto }}" alt="{{ $title[\App::getLocale()] }}" loading="lazy">
                            @endif
                        </div>
