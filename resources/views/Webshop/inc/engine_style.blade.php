<?php $shopSetting = \App\Models\ShopSettings::first();
$p_family = [];
?>
...
<style>
    :root {
        ...
        <?php if($shopSetting->custom_color_1){ ?>
            --product-label-custom-color-1: {{ $shopSetting->custom_color_1 }};
        <?php } ?>
        <?php if($shopSetting->custom_color_2){ ?>
            --product-label-custom-color-2: {{ $shopSetting->custom_color_2 }};
        <?php } ?>
        ...
        <?php $settingTimetable = \App\Models\PluginTimetableSetting::first(); ?>
        @if($settingTimetable)
        --timetable-color: {{ $settingTimetable->color }};
        @endif
