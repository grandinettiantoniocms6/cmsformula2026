...
<section id="block-parking-{{ $parking->id }}" class="block-formpro">
    <div class="container">
        ...
        <div class="row gap-3 gap-lg-0">
            <div class="col-lg-6 colonna-tariffe">
                {!! $parking->description_tariffe !!}

                @if($tariffe)
                    <div class="card">
                        <div class="card-header text-center bg-primary text-white">
                            <span class="font-weight-bold font-2xl">{{ @$labels['parking-tutte-le-tariffe'] }}</span>
                        </div>

                        <table class="table table-sm table-bordered">
                            <thead class="bg-light">
                            <tr>
                                <th class="text-center" width="100">{{ @$labels['parking-giorni'] }}</th>
                                <th class="text-center" width="100">{{ @$labels['parking-scoperto'] }}</th>
                                <th class="text-center" width="100">{{ @$labels['parking-coperto'] }}</th>
                            </tr>
                            </thead>
                            @foreach($tariffe as $tariffa)
                                <tr>
                                    <td class="text-center">{{ $tariffa->day }}</td>
                                    <td class="text-center">{{ number_format($tariffa->price_scoperto,2,",",".") }} &euro;</td>
                                    <td class="text-center">{{ number_format($tariffa->price_coperto,2,",",".") }} &euro;</td>
                                </tr>
                            @endforeach

                            <tr>
                                <td class="text-center">Dal {{ ($tariffa->day + 1) }}º gg</td>
                                <td class="text-center">+{{ number_format($setting->euro_park_scoperto,2,",",".") }} &euro;</td>
                                <td class="text-center">+{{ number_format($setting->euro_park_coperto,2,",",".") }} &euro;</td>
                            </tr>
                        </table>
                    </div>
                @endif
            ...
            <div class="col-lg-6 colonna-modulo-prenotazione">
