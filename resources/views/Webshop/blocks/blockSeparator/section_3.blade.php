        ...
        <section id="block-separator-{{ $value->id }}" class="block-separator bg-overlay image-wrapper jarallax">
            <div class="container page-container">
                <div class="row mt-md-3 p-5">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 wow animate__fadeInLeft" data-wow-duration=".6s">
                        <div class="section-title" style="margin-top:30px;">
                            ...
                            @if(trim($button[\App::getLocale()])!="")
                                <a target="{{ $type_href }}" class="btn" href="{{ $url }}">{{ $button[\App::getLocale()] }}</a>
                            @endif
                        </div>
                    </div>
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 wow animate__fadeInRight" data-wow-duration="0.8s">
                        <img src="{{ $value->foto2 }}" class="img-fluid" style="margin-top:30px;" loading="lazy" alt="{{ $title[\App::getLocale()] }}">
                    </div>
                </div>
            </div>
            @if(trim($value->foto) != "")
