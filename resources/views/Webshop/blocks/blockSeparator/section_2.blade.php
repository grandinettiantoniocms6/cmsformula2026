        ...
        <section id="block-separator-{{ $value->id }}" class="block-separator bg-overlay image-wrapper jarallax">
            <div class="container-fluid page-container">
                <div class="row mt-md-3 p-5">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 wow animate__fadeInLeft" data-wow-duration=".5s">
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="section-title wow animate__fadeInRight" data-wow-duration=".7s" style="margin-top: 40px;">
                            ...
                            @if(trim($button[\App::getLocale()])!="")
                                <a target="{{ $type_href }}" class="btn wow animate__fadeInUp" data-wow-duration="1.5s" href="{{ $url }}">{{ $button[\App::getLocale()] }}</a>
                            @endif
                        </div>
                    </div>
                </div>
