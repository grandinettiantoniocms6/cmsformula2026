        ...
        @if($array)
            ...
            >
                @foreach($array as $value)
                        ...
                        ?>
                    <div class="item" style="border: 1px solid #ececec; padding: 30px; height: {{ $item->height }}rem;">
                        <div class="card">
                            @if(trim($value->foto) != "")
                                <img class="card-img" alt="{{ $title[\App::getLocale()] }}" src="{{ $value->foto }}" class="img-fluid" loading="lazy">
                            @endif
                            <div class="card-img">
                                <h4 style="color:{!! $item->color_title !!}; margin-top: 2rem;">{{ $title[\App::getLocale()] }}</h4><br>
