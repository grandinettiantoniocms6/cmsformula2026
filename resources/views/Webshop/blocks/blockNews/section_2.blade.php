<section class="block-news style-2" id="block-news-{{ $item->id }}">
        ...
        <div class="row">
            @if($array)
                ...
                @foreach($array as $value)
                    ...
                    <div class="{{ $col_class }} x-{{ $i }} my-2">
                        <div class="card card-news style-2 wow animate__fadeInUp" data-wow-duration="1s" style="height: {{ $item->height }}rem;">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="post-meta">
                                    @if($value->date)
                                        <li class="post-date"><span>{{ \Carbon\Carbon::createFromFormat("Y-m-d" ,$value->date)->format("d/m/Y") }}</span></li>
                                    @endif
                                </ul>
                            </div>
                        </div>
