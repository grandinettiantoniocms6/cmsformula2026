<section class="block-brand wow animate__fadeInUp style-1" data-wow-duration=".3s">
                        ...
                        ?>
                            ...
                            <div class="col-lg-{{ $item->col }} col-sm-4 col-6 align-items-stretch">
                                <div class="py-1 wow animate__fadeInUp" data-wow-duration=".3s">
                                    ...
                                    @else
                                        <div class="card card-body rounded-none border-0"><img class="img-fluid mx-auto" loading="lazy" src="{{ $foto }}" title=""></div>
                                    @endif
                                </div>
                            </div>
