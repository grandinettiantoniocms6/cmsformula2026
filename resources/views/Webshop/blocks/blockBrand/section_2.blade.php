<section class="block-brand wow animate__fadeInUp style-2" data-wow-duration=".3s">
                ...
                @foreach($array as $value)
                        ...
                        ?>
                            ...
                            <div class="col-lg-{{ $item->col }} col-sm-4 col-6 align-items-stretch">
                                <div class="col py-1 wow animate__fadeInUp" data-wow-duration=".3s">
                                    ...
                                    @else
                                        <div class="card card-body rounded-none"><img class="img-fluid mx-auto" src="{{ $foto }}" title=""></div>
                                    @endif
                                </div>
                            </div>
