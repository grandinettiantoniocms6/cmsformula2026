<section id="block-image-{{ $item->id }}" class="block-image image-wrapper bg-overlay overflow-hidden bg-overlay-black-{{ $item->alpha }}"
...
>
    @if(trim($foto) != "")
        <img class="img-cover kenburns-effect" src="{{ $foto }}" alt="{{ $page->color_title_page }}" loading="lazy">
    @endif
