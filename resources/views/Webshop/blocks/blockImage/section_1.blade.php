<section id="block-image-{{ $item->id }}" class="block-image image-wrapper bg-overlay bg-overlay-black-{{ $item->alpha }} jarallax"
...
>
    @if(trim($foto) != "")
        <img class="jarallax-img" src="{{ $foto }}" alt="{{ $page->color_title_page }}" loading="lazy">
    @endif
