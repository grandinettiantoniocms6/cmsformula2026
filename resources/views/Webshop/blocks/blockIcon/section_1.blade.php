                ...
                @foreach($array as $value)
                        ...
                        ?>
                            ...
                            <style>
                                ...
                                #block-icons-{{ $item->id }} a:link { text-decoration: none !important; }
                            </style>

                            <div class="col-lg-{{ $item->col }} col-md-6 col-sm-6 mb-3">
                                <div class="card wow animate__fadeInUp" style="background-color: {{ $value->bgcolor }}!important;" data-wow-duration=".3s">
                                    @if($value->icon)
                                        <div class="icon">
                                            @if($url != "#")
                                    ...
                                    @else
                                        @if(trim($value->foto) != "")
                                            @if($url != "#")
                                                <a style="margin-left: 0px!important;" target="{{ $type_href }}" href="{{ $url }}" ><img src="{{ $foto }}" title="" loading="lazy"></a>
                                            @else
                                                <img style="margin-left: 0px!important;" src="{{ $foto }}" title="" loading="lazy" class="mx-auto">
                                            @endif
                                        @endif
                                    @endif
