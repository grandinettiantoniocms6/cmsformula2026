                ...
                @foreach($array as $value)
                    ...
                    <style>
                        ...
                        <div class="col-lg-{{ $item->col }} col-md-6 col-sm-6 mb-3">
                            <div style="background-color: {{ $item->bgcolor_hover }}!important;" data-wow-duration=".3s">

                                    @if($url != "#")
                                        <a target="{{ $type_href }}" href="{{ $url }}" class="btn btn-block" style="background-color: {{ $value->bgcolor_button }}!important; border-color: {{ $value->bgcolor_button }}; color: {{ $value->color_text_button }}!important; width: 100%; align-items: center;">
