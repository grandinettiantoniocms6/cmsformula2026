...
<section class="block-icons style-{{ $item->style }}" id="block-icons-{{ $item->id }}" style="background-color: {{ $value->bgcolor }}!important;">
    <div class="{{ $item->fullwidth }}">
        <div class="row">
            <div class="col-lg-{{ $item->col }} col-md-6 col-sm-6 mb-3 aos-init aos-animate" data-aos="fade-up" style="background-color: {{ $value->bgcolor }}!important;">
                <div class="row">
                    <div class="col-lg-3">
                                @if($value->icon)
                                    <div class="icon">
