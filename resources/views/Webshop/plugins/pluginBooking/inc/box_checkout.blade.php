                ...
                <form id="form" method="post" action="{{ route('pluginBooking.checkout.it') }}" class="card">
                    ...
                    <div class="p-4 p-md-5">
                        ...
                        <div class="form-group">
                            ...
                            echo "<button class='button btn btn-lg btn-primary w-100{$recaptchaClass}'{$recaptchaAttributes} style='background-color: {$website->btn_background}; border-color: {$website->btn_colorborder};' type='button' id='submit_button' > <span style='color: {$website->btn_txt_color}'> {$labels['booking-login-registrati']} </span></button>";
                            ?>
                        </div>
                    </div>
                </form>
