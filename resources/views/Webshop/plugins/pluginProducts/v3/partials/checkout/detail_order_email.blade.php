...
?>
<table border="1" cellpadding="0" cellspacing="0" style="font-family: Helvetica; text-align: left!important; border-color: red; background:#ffffff; max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer order">
    <thead>
    <tr>
        <th></th>
        <th><strong>{{ @$labels['shop-partials-prodotto'] }}</strong></th>
