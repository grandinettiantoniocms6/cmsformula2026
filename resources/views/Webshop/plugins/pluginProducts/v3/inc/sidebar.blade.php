                            ...
                            @foreach($tags as $k=>$tag)
                                @if(trim($tag) != "")
                                    ...
                                    <div class="tag-element">
                                        <input onclick="filters_check('tags_check');" type="checkbox" class="btn-check tags_check" id="check-tag-<?php echo $k;?>" name="tags_check[]" value="{{ $tag }}" @if(trim($checked_tag) == trim($tag)) checked @endif>
