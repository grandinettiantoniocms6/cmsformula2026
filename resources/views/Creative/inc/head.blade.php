...
<!-- Font Color Skin -->
@if($website->skin_css)
    <link rel="stylesheet" type="text/css" href="{{ url("$website->skin_css") }}" />
@else
    <!-- non uso le skins -->
@endif

<!-- Main style sheet -->
<link rel="stylesheet" type="text/css" href="{{ url("templates/Creative/css/style.css") }}" media="all">
<!-- responsive style sheet -->
<link rel="stylesheet" type="text/css" href="{{ url("templates/Creative/css/responsive.css") }}" media="all">
<!-- Customizzazioni Tema Creative -->
<link rel="stylesheet" type="text/css" href="{{ url("css_common/creative_custom.css") }}" />

<!-- Fix Internet Explorer ______________________________________-->
<!--[if lt IE 9]>
<script src="https://html5shiv.googlecode.com/svn/trunk/html5.js"></script>
<script src="{{ url("templates/Creative/vendor/html5shiv.js") }}"></script>
<script src="{{ url("templates/Creative/vendor/respond.js") }}"></script>
<![endif]-->

<!-- Prima vanno messi i css style e tipografy del tema e poi metto questa regola qui sotto che carica i Font Color Style css di Basic da admin -->
