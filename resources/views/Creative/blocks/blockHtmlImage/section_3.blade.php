    <div class="row justify-content-center pb-{{ $item->pb }}">
            <div class="col-lg-8">
                <div class="owl-carousel" id="slider-carosello" data-autoheight="true" data-nav-dots="true" data-items="1" data-md-items="1" data-sm-items="1" data-xs-items="1" data-xx-items="1" data-space="20">
                    ...
                    @if(@$value->foto3)
                        <div class="item">
                            <img src="{{ $value->foto3 }}" class="img-fluid full-width" alt="">
                        </div>
                    @endif
                    @if(@$value->foto4)
                        <div class="item">
                            <img src="{{ $value->foto4 }}" class="img-fluid full-width" alt="">
                        </div>
                    @endif
                    @if(@$value->foto5)
                        <div class="item">
                            <img src="{{ $value->foto5 }}" class="img-fluid full-width" alt="">
                        </div>
                    @endif
                    @if(@$value->foto6)
                        <div class="item">
                            <img src="{{ $value->foto6 }}" class="img-fluid full-width" alt="">
                        </div>
                    @endif
                    @if(@$value->foto7)
                        <div class="item">
                            <img src="{{ $value->foto7 }}" class="img-fluid full-width" alt="">
                        </div>
                    @endif
                    @if(@$value->foto8)
                        <div class="item">
                            <img src="{{ $value->foto8 }}" class="img-fluid full-width" alt="">
                        </div>
                    @endif
                    @if(@$value->foto9)
                        <div class="item">
                            <img src="{{ $value->foto9 }}" class="img-fluid full-width" alt="">
                        </div>
                    @endif
                    @if(@$value->foto10)
                        <div class="item">
                            <img src="{{ $value->foto10 }}" class="img-fluid full-width" alt="">
                        </div>
                    @endif
