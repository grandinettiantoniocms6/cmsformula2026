<section class="blockquote-section page-section-ptb" style="background-color: {{ $value->bg_color }};">
    <div class="container">
        <div class="row no-gutter">
            <div class="col-sm-12 text-left blockquote-section-left">
    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-sm-12 text-center">
                <div class="owl-carousel" data-items="3" data-md-items="3" data-sm-items="2" data-xs-items="1" data-xx-items="1" data-space="0">
