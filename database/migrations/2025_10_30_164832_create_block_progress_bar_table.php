...
return new class extends Migration
{
    ...
    {
        Schema::create('blocks_progress_bars', function (Blueprint $table) {
            ...
            $table->string('txtcolor_skill')->nullable();
            $table->string('bgcolor_skill')->nullable();
            $table->string('barcolor_skill')->nullable();
            $table->unsignedInteger('percent_skill')->default(25);
            ...
            $table->string('txtcolor_button')->nullable();
    ...
    {
        Schema::dropIfExists('blocks_progress_bars');
    }
};
