...
use App\Http\Requests\BlockHtmlTwocolRequest;
...
/**
 * Class BlockHtmlTwocolCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class BlockHtmlTwocolCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\BlockHtmlTwocol::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/blockHtmlTwocol');
        CRUD::setEntityNameStrings('HTML 2 colonne', 'HTML 2 colonne');
    ...
    {
        CRUD::setValidation(BlockHtmlTwocolRequest::class);
        ...
        if(request()->has('multi')){
            ...
            $this->crud->addField([   // repeatable
                'name'  => 'pb',
                'label' => 'Spazio tra le righe (00 nullo | 150 massimo ) - Per impostare la spaziatura a te più gradita, prova ad aumentare di 10 il valore)',
                'type'  => 'number',
            ]);
    ...
    public function store()
    {
        ...
        $lft = BlockHtmlTwocol::whereNotNull("block_id")
