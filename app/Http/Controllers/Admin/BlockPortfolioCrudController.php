...
use App\Http\Requests\BlockPortfolioRequest;
 ...
 */
class BlockPortfolioCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\BlockPortfolio::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/blockPortfolio');
    ...
    {
        CRUD::setValidation(BlockPortfolioRequest::class);
    ...
    public function store()
    {
        ...
        $lft = BlockPortfolio::whereNotNull("block_id")
