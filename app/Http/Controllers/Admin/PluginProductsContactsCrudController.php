...
use App\Http\Requests\PluginProductsContactsRequest;
...
/**
 * Class PluginProductsContactsCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class PluginProductsContactsCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\PluginProductsContacts::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/pluginProductsContacts');
    ...
    {
        CRUD::setValidation(PluginProductsContactsRequest::class);
        ...
        if($pluginSetting->show_attributes_form_contact == 1){
            $fields["attributes"] = "Accessori";
        }
        ...
        $trans->fields_lang("pluginProductsContacts", $this->crud, $custom);
    ...
    public function update()
    {
        ...
        $lang->update_lang("pluginProductsContacts", $this->crud, $request);
