...
/**
 * Class BlockMetroCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class BlockMetroCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\BlockMetro::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/blockMetro');
        CRUD::setEntityNameStrings('Blocco Metro', 'Blocchi Metro');
    ...
    {
        CRUD::setValidation(BlockMetroRequest::class);
    ...
    public function store()
    {
        ...
        $lft = BlockMetro::orderBy("lft", "asc")->first();
        if($lft){
