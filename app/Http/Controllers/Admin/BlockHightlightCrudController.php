...
use App\Http\Requests\BlockHightlightRequest;
...
/**
 * Class BlockHightlightCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class BlockHightlightCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\BlockHightlight::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/blockHightlight');
        CRUD::setEntityNameStrings('In evidenza', 'In evidenza');
    ...
    {
        CRUD::setValidation(BlockHightlightRequest::class);
        ...
        $trans = new AdminLanguageController();
        $trans->fields_lang("blockHightlightConf", $this->crud);
    ...
    public function update()
    {
        ...
        //questo if esiste solo nei blocchi is_multi
        if($request->has('name')){
