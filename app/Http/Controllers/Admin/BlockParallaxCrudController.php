...
use App\Http\Requests\BlockParallaxRequest;
...
/**
 * Class BlockParallaxCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class BlockParallaxCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\BlockParallax::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/blockParallax');
        CRUD::setEntityNameStrings('Blocco Parallax', 'Blocchi Parallax');
    ...
    {
        CRUD::setValidation(BlockParallaxRequest::class);
        ...
        if(request()->has('multi')){
            ...
            $this->crud->addField([   // repeatable
                'name'  => 'alpha',
                'label' => 'Filigrana (00 nulla - 10 leggera - 90 pesante - tra 10 e 90 custom)',
                'type'  => 'number',
            ]);
    ...
    public function store()
    {
        ...
        $lft = BlockParallax::whereNotNull("block_id")
