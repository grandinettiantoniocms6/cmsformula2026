...
/**
 * Class BlockFlussoCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class BlockFlussoCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\BlockFlusso::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/blockFlusso');
        CRUD::setEntityNameStrings('Elenco numerato stile flusso', 'Elenchi numerati stile flusso');
    ...
    {
        CRUD::setValidation(BlockFlussoRequest::class);
        ...
        /* Perchè il resto dei input multilingua li dichiaro nel AdminLanguageController */
            ...
            $this->crud->addField([   // repeatable
                'name'  => 'number',
                'label' => 'Numero (Esempio: Scrivi 1 o 01) ',
                'type'  => 'text',
            ]);
    ...
    public function store()
    {
        ...
        $lft = BlockFlusso::whereNotNull("block_id")
