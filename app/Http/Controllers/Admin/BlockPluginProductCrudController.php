...
use App\Http\Requests\BlockPluginProductRequest;
use App\Models\PluginProductsCategories;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class BlockPluginProductCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class BlockPluginProductCrudController extends CrudController
{
    ...
    public $block = "blockPluginProduct";
    /**
    ...
    {
        CRUD::setModel(\App\Models\BlockPluginProduct::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/blockPluginProduct');
        CRUD::setEntityNameStrings('catalogo plugin', 'catalogo plugin');
    ...
    {
        CRUD::setValidation(BlockPluginProductRequest::class);
        ...
        if(request()->has('multi')){
            ...
            $categories = PluginProductsCategories::where("is_active", 1)->get()->pluck("name", "id")->toArray();
