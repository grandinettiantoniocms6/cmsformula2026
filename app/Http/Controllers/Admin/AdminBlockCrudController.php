    ...
    protected function setupListOperation()
    {
        ...
        $this->crud->setColumns([
            ...
            [
                // run a function on the CRUD model and show its return value
                'name'  => 'is_ordinable',
                'label' => 'Ordinabile', // Table column heading
                'type'  => 'model_function',
                'function_name' => 'getIsOrdinable', // the method in your Model
                // 'function_parameters' => [$one, $two], // pass one/more parameters to that method
                'limit' => 10000, // Limit the number of characters shown
            ],
            [
                // run a function on the CRUD model and show its return value
                'name'  => 'is_multi',
                'label' => 'Blocco multiplo', // Table column heading
                'type'  => 'model_function',
                'function_name' => 'getIsMulti', // the method in your Model
                // 'function_parameters' => [$one, $two], // pass one/more parameters to that method
                'limit' => 10000, // Limit the number of characters shown
            ],
        ]);
