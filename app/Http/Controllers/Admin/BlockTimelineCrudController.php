...
use App\Http\Requests\BlockTimelineRequest;
...
/**
 * Class BlockTimelineCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class BlockTimelineCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\BlockTimeline::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/blockTimeline');
        CRUD::setEntityNameStrings('Blocco Timeline', 'Blocchi Timelines');
    ...
    protected function setupReorderOperation()
    {
        ...
        $this->crud->set('reorder.label', 'date');
    ...
    {
        CRUD::setValidation(BlockTimelineRequest::class);
        ...
        if(request()->has('multi')){
            ...
            $this->crud->addField([   // select_from_array
                ...
                'options'     => [1 => 'Style 1: Classico', 2 => 'Style 2: Data a sinistra e titolo e testo a destra'],
                'allows_null' => false,
                'default'     => 1,
    ...
    public function update()
    {
        ...
        if($request->has('name')){
            ...
            $this->crud->entry->bg_color = $request->get('bg_color');
