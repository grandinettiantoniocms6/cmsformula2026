...
class BlockCollageRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            'foto_sx.required' => 'Foto obbligatoria',
            'foto_dx.required' => 'Foto obbligatoria'
        ];
    ...
    public function messages()
    {
        ...
        return [
            ...
            'foto_sx.required' => 'Foto sinistra obbligatoria',
            'foto_dx.required' => 'Foto destra obbligatoria'
