...
class CreateThumbBrands extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'create:thumb_brands';
    ...
    public function handle()
    {
        try{
            ...
            $destination_path = "public/thumb/plugin_brands";
            ...
            $images = PluginProductsBrands::orderBy("id", "desc")->get();
            if($images){
