...
class BlockSeparator extends Model
{
    use CrudTrait;
    ...
    */
    use HasTranslations;
    public $translatable = ['title','subtitle','description','url_interno','url','button'];

    protected $table = 'blocks_separators';
    ...
    */
    ...
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_separators/$temp[0]-mini.webp";
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_separators";
        ...
        $adminBlock = AdminBlock::where("name", "blockSeparator")->first();
