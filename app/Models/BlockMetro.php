...
class BlockMetro extends Model
{
    use CrudTrait;
    ...
    */
    ...
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_metros/$temp[0]-mini.webp";
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_metros";
        ...
        $adminBlock = AdminBlock::where("name", "blockMetro")->first();
