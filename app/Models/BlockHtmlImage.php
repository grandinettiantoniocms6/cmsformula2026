...
class BlockHtmlImage extends Model
{
    use CrudTrait;
    use HasTranslations;
    public $translatable = ['title', 'description', 'url_interno','url','button'];
    /*
    |--------------------------------------------------------------------------
    | GLOBAL VARIABLES
    |--------------------------------------------------------------------------
    */
    ...
    protected $table = 'blocks_htmlimages';
    ...
    */
    ...
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_htmlimages/$temp[0]-mini.webp";
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_htmlimages";
        ...
        $adminBlock = AdminBlock::where("name", "blockHtmlImage")->first();
    ...
    // copio x volte a seconda delle immagini aggiuntive necessarie cambiando il nome del attribute_name
    public function setFoto2Attribute($value)
    {
        $attribute_name = "foto2";
        $disk = config('backpack.base.root_disk_name');
        $destination_path = "public/thumb/blocks_htmlimages";
    ...
    public function setFoto7Attribute($value)
    {
        $attribute_name = "foto7";
        $disk = config('backpack.base.root_disk_name');
        $destination_path = "public/thumb/blocks_htmlimages";
    ...
    public function setFoto8Attribute($value)
    {
        $attribute_name = "foto8";
        $disk = config('backpack.base.root_disk_name');
        $destination_path = "public/thumb/blocks_htmlimages";
    ...
    public function setFoto9Attribute($value)
    {
        $attribute_name = "foto9";
        $disk = config('backpack.base.root_disk_name');
        $destination_path = "public/thumb/blocks_htmlimages";
    ...
    public function setFoto10Attribute($value)
    {
        $attribute_name = "foto10";
        $disk = config('backpack.base.root_disk_name');
        $destination_path = "public/thumb/blocks_htmlimages";
    ...
    // -------Fine Sistema che genera la THUMB

    /* Commento foto singolo upload+crop
    public function setFotoAttribute($value)
    {
        $attribute_name = "foto";
        ...
        $destination_path = "public/uploads/blocks_htmlimages";
