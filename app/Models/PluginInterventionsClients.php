...
class PluginInterventionsClients extends Model
{
    use CrudTrait;
    use SoftDeletes;
    /*
    ...
    */
    ...
    protected $table = 'plugins_interventions_clients';
    ...
    */
    ...
    public function getMenu()
    {
        ...
        $link_annulla = '<a href="javascript:void(0)" onclick="deleteEntry(this)" data-route="/admin/' . $type . '/' . $this->id . '" class="dropdown-item" data-button-type="delete">Elimina</a>';
