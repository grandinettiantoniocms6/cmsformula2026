...
class BlockHero extends Model
{
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    // Sistema che genera la THUMB per sfondo
    public function get_foto_mini(){
        if($this->foto){
            $basename = basename($this->foto);
            $temp = explode(".", $basename);

            $check = "thumb/blocks_heros/$temp[0]-mini.webp";
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_heros";
        ...
        $adminBlock = AdminBlock::where("name", "blockHero")->first();
        ...
        if(count($adminThumb)){
            foreach ($adminThumb as $thumb){
                ...
                $absolute = resolveImagePath($value);
    ...
    public function setSfondoAttribute($value)
    {
        $attribute_name = "sfondo";
        $disk = config('backpack.base.root_disk_name');
        $destination_path = "public/thumb/blocks_heros";
    ...
    // copio x volte a seconda delle immagini aggiuntive necessarie cambiando il nome del attribute_name
    public function setFoto_mobile_1Attribute($value)
    {
        $attribute_name = "foto_mobile_1";
        $disk = config('backpack.base.root_disk_name');
        $destination_path = "public/thumb/blocks_heros";
    ...
    // copio x volte a seconda delle immagini aggiuntive necessarie cambiando il nome del attribute_name
    public function setFoto_mobile_2Attribute($value)
    {
        $attribute_name = "foto_mobile_2";
        $disk = config('backpack.base.root_disk_name');
        $destination_path = "public/thumb/blocks_heros";
