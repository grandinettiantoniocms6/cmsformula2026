...
class BlockCarousel extends Model
{
    use CrudTrait;
    ...
    */
    ...
    public $translatable = ['title','abstract', 'description', 'url_interno','url','button'];

    protected $table = 'blocks_carousels';
    ...
    */
    ...
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_carousels/$temp[0]-mini.webp";
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_carousels";
        ...
        $adminBlock = AdminBlock::where("name", "blockCarousel")->first();
