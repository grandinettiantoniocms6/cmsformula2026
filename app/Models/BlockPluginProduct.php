...
class BlockPluginProduct extends Model
{
    use CrudTrait;
    ...
    */
    ...
    protected $table = 'blocks_plugins_products';
    ...
    */
    function getCategory(){
        ...
        $category = PluginProductsCategories::where("id", $this->category_id)->first();
        if($category){
