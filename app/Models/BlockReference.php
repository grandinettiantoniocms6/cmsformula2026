...
class BlockReference extends Model
{
    ...
    */
    ...
    public $translatable = ['title','category','description','url_interno','url','button'];

    protected $table = 'blocks_references';
    ...
    */
    ...
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_references/$temp[0]-mini.webp";
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_references";
        ...
        $adminBlock = AdminBlock::where("name", "blockReference")->first();
