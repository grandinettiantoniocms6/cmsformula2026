...
class BlockParallax extends Model
{
    use CrudTrait;
    ...
    */
    ...
    protected $table = 'blocks_parallaxs';
    ...
    */
    ...
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_parallaxs/$temp[0]-mini.webp";
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_parallaxs";
        ...
        $adminBlock = AdminBlock::where("name", "blockParallax")->first();
