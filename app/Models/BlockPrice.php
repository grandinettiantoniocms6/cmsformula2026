...
class BlockPrice extends Model
{
    ...
    */
    ...
    public $translatable = ['title','license_title','license_subtitle','service_title','service_subtitle','listing','list','description','license_note','url_interno','url','button'];

    protected $table = 'blocks_prices';
