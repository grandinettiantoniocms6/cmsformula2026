...
class BlockMetrox extends Model
{
    use CrudTrait;
    ...
    */
    ...
    protected $table = 'blocks_metroxs';
    ...
    */
    ...
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_metroxs/$temp[0]-mini.webp";
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_metroxs";
        ...
        $adminBlock = AdminBlock::where("name", "blockMetrox")->first();
