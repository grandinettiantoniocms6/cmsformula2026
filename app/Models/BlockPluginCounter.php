...
class BlockPluginCounter extends Model
{
    use CrudTrait;
    ...
    */
    ...
    protected $table = 'blocks_plugins_counters';
    ...
    */
    function getCounter(){
        if(!$this->plugin_counter_id){
            return "";
        }

        $category = PluginCounter::where("id", $this->plugin_counter_id)->first();
        if($category){
    ...
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_gallerys/$temp[0]-mini.webp";
    ...
    {
        $attribute_name = "bgimage";
        $disk = config('backpack.base.root_disk_name');
        $destination_path = "public/thumb/blocks_plugins_counters";
        ...
        $adminBlock = AdminBlock::where("name", "blockPluginCounter")->first();
    ...
    // Fine sistema Thumb 2.0

    public function getMenu()
    {
        $type = "blockPluginCounter";
