...
class BlockContactgmap extends Model
{
    use CrudTrait;
    ...
    */
    ...
    public $translatable = ['subtitle','title','description','description2'];

    protected $table = 'blocks_contactgmaps';
    ...
    */
    ...
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_contactgmails/$temp[0]-mini.webp";
            ...
            $url = url($this->foto);
            return "<img src='$url' style='width: 170px; border-radius: 3px;'>";
        }
    }
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_contactgmails";
        ...
        $adminBlock = AdminBlock::where("name", "blockBanner")->first();
