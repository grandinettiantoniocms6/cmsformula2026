...
class BlockPortfolio2 extends Model
{
    use CrudTrait;
    use HasTranslations;
    ...
    */
    ...
    protected $table = 'blocks_portfolio2s';
    ...
    */
    ...
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_portfolio2s/$temp[0]-mini.webp";
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_portfolio2s";
        ...
        $adminBlock = AdminBlock::where("name", "blockPortfolio2")->first();
    ...
    // Fine sistema creazione thumb

    public function getMenu()
    {
        $type = "blockPortfolio2";
