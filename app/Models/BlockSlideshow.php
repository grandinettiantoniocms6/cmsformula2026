...
class BlockSlideshow extends Model
{
    use CrudTrait;
    use HasTranslations;
    ...
    */
    ...
    protected $table = 'blocks_slideshows';
    ...
    */
    ...
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_slideshows/$temp[0]-mini.webp";
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_slideshows";
        ...
        $adminBlock = AdminBlock::where("name", "blockSlideshow")->first();
    ...
    public function setFotoMobileAttribute($value)
    {
        $slide_height ="";

        $attribute_name = "foto_mobile";
        $disk = config('backpack.base.root_disk_name');
        $destination_path = "public/thumb/blocks_slideshows";
    ...
    /*public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/uploads/blocks_slideshows";
