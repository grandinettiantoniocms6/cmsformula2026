...
class BlockGrid extends Model
{
    ...
    */
    ...
    public $translatable = ['title','description','text_etichetta','url_interno','url','button'];

    protected $table = 'blocks_grids';
    ...
    */
    ...
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_grids/$temp[0]-mini.webp";
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_grids";
        ...
        $adminBlock = AdminBlock::where("name", "blockGrid")->first();
