...
class BlockProgressbar extends Model
{
    use CrudTrait;
    use HasFactory;
    ...
    */
    ...
    public $translatable = ['title','description','label','skill','url_interno','url','button'];

    protected $table = 'blocks_progress_bars';
    ...
    */
    ...
    // Sistema che genera la THUMB 2.0
    public function get_foto_mini(){
        if($this->foto){
            $basename = basename($this->foto);
            $temp = explode(".", $basename);

            $check = "thumb/blocks_progressbar/$temp[0]-mini.webp";
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_progressbar";
        ...
        $adminBlock = AdminBlock::where("name", "blockProgressbar")->first();
