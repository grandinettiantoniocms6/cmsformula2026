...
class BlockScrollbar extends Model
{
    use CrudTrait;
    ...
    */
    ...
    protected $table = 'blocks_scrollbars';
    ...
    */
    ...
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_scrollbars/$temp[0]-mini.webp";
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_scrollbars";
        ...
        $adminBlock = AdminBlock::where("name", "blockScrollbar")->first();
