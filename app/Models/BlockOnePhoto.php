...
class BlockOnePhoto extends Model
{
    use CrudTrait;
    ...
    */
    ...
    protected $table = 'blocks_one_photos';
    ...
    */
    ...
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_one_photos/$temp[0]-mini.webp";
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_one_photos";
        ...
        $adminBlock = AdminBlock::where("name", "blockOnePhoto")->first();
