...
class BlockListOfLink extends Model
{
    use CrudTrait;
    use HasFactory;
    ...
    */
    ...
    public $translatable = ['title','label','url_interno','url','button'];

    protected $table = 'blocks_list_of_links';
    ...
    */
    ...
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_listoflinks/$temp[0]-mini.webp";
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_listoflinks";
        ...
        $adminBlock = AdminBlock::where("name", "blockListOfLink")->first();
