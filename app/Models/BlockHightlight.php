...
class BlockHightlight extends Model
{
    use CrudTrait;
    ...
    */
    ...
    protected $table = 'blocks_hightlights';
    ...
    */
    ...
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_hightlights/$temp[0]-mini.webp";
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_hightlights";
        ...
        $adminBlock = AdminBlock::where("name", "blockHightlight")->first();
