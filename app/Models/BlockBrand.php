...
class BlockBrand extends Model
{
    use CrudTrait;
    ...
    */
    ...
    public $translatable = ['title', 'url_interno','url','button'];

    protected $table = 'blocks_brands';
    ...
    */
    ...
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_brands/$temp[0]-mini.webp";
            ...
            $url = url($this->foto);
            return "<img src='$url' style='width: 160px; border-radius: 3px;'>";
        }
    }
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_brands";
        ...
        $adminBlock = AdminBlock::where("name", "blockBrand")->first();
