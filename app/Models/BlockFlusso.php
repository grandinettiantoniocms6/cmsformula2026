...
class BlockFlusso extends Model
{
    use CrudTrait;
    ...
    */
    ...
    public $translatable = ['title','number','description','url_interno','url','button'];

    protected $table = 'blocks_flussos';
    ...
    */
    /*public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/uploads/blocks_carousels";
