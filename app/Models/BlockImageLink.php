...
class BlockImageLink extends Model
{
    use CrudTrait;
    ...
    */
    use HasTranslations;
    public $translatable = ['title', 'description', 'text_box_icon', 'url_interno','url','button'];

    protected $table = 'blocks_images_links';
    ...
    */
    ...
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_images_links/$temp[0]-mini.webp";
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_images_links";
        ...
        $adminBlock = AdminBlock::where("name", "blockImageLink")->first();
...
// Fine sistema Thumb
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/uploads/blocks_images_links";
