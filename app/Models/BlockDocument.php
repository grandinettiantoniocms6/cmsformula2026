...
class BlockDocument extends Model
{
    use CrudTrait;
    use HasTranslations;
    ...
    */
    ...
    protected $table = 'blocks_documents';
    ...
    */
    public function getFile(){
        return "<a href='/uploads/$this->file' target='_blank'>Clicca qui</a>";
    }
    ...
    /*public function setFileAttribute($value)
    {
        $attribute_name = "file";
        $disk = "public_uploads";
        $destination_path = "blocks_documents";
