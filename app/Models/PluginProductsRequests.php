...
class PluginProductsRequests extends Model
{
    use CrudTrait;
    ...
    */
    ...
    protected $table = 'plugins_products_requests';
    ...
    */
    ...
    public function getIsRead(){
        if($this->is_read == 1){
            ...
            $url = route('dashboard.set.field.boolean', ['plugins_products_requests', $this->id, "is_read", 1]);
            if(backpack_user()->roles[0]->id == 4){
    ...
    public function getProductOrOrder(){
        if($this->product_id){
