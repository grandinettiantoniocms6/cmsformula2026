...
class BlockHtmlbook extends Model
{
    use CrudTrait;
    use HasFactory;
    ...
    */
    ...
    protected $table = 'blocks_htmlbooks';
...
// Sistema che genera la THUMB
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_htmlbooks/$temp[0]-mini.webp";
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_htmlbooks";
        ...
        $adminBlock = AdminBlock::where("name", "blockHtmlbook")->first();
