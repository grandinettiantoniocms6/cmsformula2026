...
class BlockScrollingtext extends Model
{
    use CrudTrait;
    ...
    */
    ...
    public $translatable = ['title','url_interno','url'];

    protected $table = 'blocks_scrolling_texts';
    ...
    */
    ...
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_scrollingtexts/$temp[0]-mini.webp";
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_scrollingtexts";
        ...
        $adminBlock = AdminBlock::where("name", "blockScrollingtext")->first();
