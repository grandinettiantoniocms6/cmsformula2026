...
class BlockHtmlTwocol extends Model
{
    use CrudTrait;
    ...
    */
    ...
    protected $table = 'blocks_htmltwocols';
    ...
    */
    ...
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_htmltwocols/$temp[0]-mini.{$temp[1]}";
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_htmltwocols";
        ...
        $filename = "$nameFile[0]-large.webp";
