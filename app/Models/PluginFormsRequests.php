...
class PluginFormsRequests extends Model
{
    use CrudTrait;
    ...
    */
    ...
    protected $table = 'plugins_forms_requests';
    ...
    public function getIsRead(){
        if($this->is_read == 1){
            $url = route('dashboard.set.field.boolean', ['plugins_forms_requests', $this->id, "is_read", 0]);
            ...
            $url = route('dashboard.set.field.boolean', ['plugins_forms_requests', $this->id, "is_read", 1]);
            if(backpack_user()->roles[0]->id == 4){
    ...
    public function getForm(){
        if($this->form_id){
            $form = PluginForms::find($this->form_id);
            if($form){
                return $form->name;
            }
        }
    ...
    public function getMenu(){
        ...
        $html = '<div class="dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="'.$url_edit.'">Visualizza</a>
                    <a class="dropdown-item" href="'.$url_print.'">Stampa PDF</a>
