...
class BlockCountdown extends Model
{
    use CrudTrait;
    use HasFactory;
    ...
    */
    ...
    protected $table = 'blocks_countdowns';
    ...
    public function get_foto_mini(){
        if($this->foto){
            ...
            $check = "thumb/blocks_countdown/$temp[0]-mini.webp";
    ...
    public function setFotoAttribute($value)
    {
        ...
        $destination_path = "public/thumb/blocks_countdown";
        ...
        $adminBlock = AdminBlock::where("name", "blockCountdown")->first();
