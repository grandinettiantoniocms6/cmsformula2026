...
class PluginProductsOptions extends Model
{
    use CrudTrait;
    use HasTranslations;
    use SoftDeletes;
    ...
    */
    ...
    protected $table = 'plugins_products_options';
    // protected $primaryKey = 'id';
    // public $timestamps = false;
    protected $guarded = ['id', 'attribute_new'];
    // protected $fillable = [];
    // protected $hidden = [];
    // protected $dates = [];
    ...
    */
    public function attribute(){
        return $this->belongsTo(PluginProductsAttributes::class, "attribute_id");
    }


    public function getMenu()
    {
        $type = "pluginProductsOptions";
