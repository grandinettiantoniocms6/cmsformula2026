...
Route::group(['prefix' => config('backpack.base.route_prefix'), 'middleware' => ['admin'], 'namespace' => 'Admin'], function()
{
    ...
    Route::get('/pdf/pluginLabel/{id}', ['as' => 'pdf.pluginLabel', 'uses'=>'PluginLabelsCrudController@pdf']);
    ...
    Route::post('plugin/pluginProducts/importSpecialMapping',['as' => 'pluginProducts.importSpecialMapping', 'uses'=>'PluginProductsImportCrudController@importSpecialMapping']);
    Route::post('plugin/pluginProducts/importSpecialMappingSave',['as' => 'pluginProducts.importSpecialMappingSave', 'uses'=>'PluginProductsImportCrudController@importSpecialMappingSave']);
...
if(env("APP_KEY") != "" && env('SPECIAL_SHOP') == 1){
